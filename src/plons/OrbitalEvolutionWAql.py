...
def plot_orbit(data, setup,loc):
    ...
    posCompT = data['posComp'].transpose()
    posAGBT = data['posAGB'].transpose()
    xc, yc = posCompT[0], posCompT[1]
    xa, ya = posAGBT[0], posAGBT[1]
    ...
    if setup['triple_star']==True:
        posCompInT = data['posComp_in'].transpose()
        xc_in, yc_in = posCompInT[0], posCompInT[1]
