...
# calculates orbital separation and r of the COM, used sinkData (d)
def calcRadii(d):
    t  = d['time']
    x1 = d['posComp'].transpose()[0] 
    x2 = d['posAGB' ].transpose()[0]
    y1 = d['posComp'].transpose()[1]
    y2 = d['posAGB' ].transpose()[1]
    z1 = d['posComp'].transpose()[2]
    z2 = d['posAGB' ].transpose()[2]
    M1 = d['massComp']
    M2 = d['massAGB' ]
...
# uses sinkData = d
def calcPeaksOrbSep(d, setup, radii):
...
def plot_orbit(sinkData,setup, radii,ax):
    d  = sinkData 
    r  = radii 
    t  = d['time' ]
    rC = d['rComp']
    ...
    xc = d['posComp'].transpose()[0] 
    xa = d['posAGB' ].transpose()[0]
    yc = d['posComp'].transpose()[1]
    ya = d['posAGB' ].transpose()[1]
    zc = d['posComp'].transpose()[2]
    za = d['posAGB' ].transpose()[2]
